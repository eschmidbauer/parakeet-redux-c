/* Generated from Python unicodedata 15.0.0: inclusive code point ranges of the
   Unicode general categories Pc, Pd, Ps, Pe, Pi, Pf and Po. */
#ifndef PK_UNICODE_PUNCT_H
#define PK_UNICODE_PUNCT_H
#include <stdint.h>
static const uint32_t pk_punct_ranges[][2] = {
...
#define PK_PUNCT_RANGE_COUNT 191
#endif
